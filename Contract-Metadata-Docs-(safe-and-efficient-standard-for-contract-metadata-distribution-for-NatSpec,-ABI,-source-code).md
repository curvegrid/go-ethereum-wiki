This is the main entry point for NatSpec and generally details a _standard_ for ethereum contract metadata distribution.

By metadata we mean all information related to a contract that is thought to be relevant immutable linked to a specific version of a contract on the ethereum blockchain.
This includes:
